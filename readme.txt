TyranoScript｜ティラノスクリプト　Ver2.66（C）ShikemokuMK
http://tyrano.jp
...
（禁止事項）
・改修したティラノスクリプトの再配布。及び、他のライブラリに含めての配布。

・Webサービスに組み込むことは可能です。ただし、ティラノスクリプトを含んだ形で
　ダウンロードさせることはできません。（再配布に該当します）
　
　また、ゲーム制作でなく、Webサービスなどに組み込む場合
　ティラノスクリプトを利用していることの記述とリンク(http://tyrano.jp)が必要です
　
　
■免責事項■
